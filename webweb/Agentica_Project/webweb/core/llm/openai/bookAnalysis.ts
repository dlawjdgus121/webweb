 ...
 */
export async function extractBookInfoFromText(input: string) {
  const prompt = `
다음 문장에서 책 제목, 읽은 페이지, 감상평을 추출하세요.
- 책 제목은 정확히 표기하고, 맞춤법이 다르면 보정합니다.
- 페이지 정보는 "34쪽", "1권 50페이지" 등 다양한 표현을 인식합니다.
- 감상평은 사용자의 느낌이나 의견으로 자유롭게 표현된 문장을 추출합니다.
- 확실하지 않으면 후보를 1~3개까지 제시하고 신뢰도를 함께 반환합니다.
출력 형식(JSON):
{
  "title": "정확한 책 제목",
  "page": 0,                // 읽은 마지막 페이지
